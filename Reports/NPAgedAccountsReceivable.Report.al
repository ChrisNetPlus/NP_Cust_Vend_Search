report 50012 "NP Aged Accounts Receivable"
{
    DefaultLayout = RDLC;
    RDLCLayout = './NP_Aged_Accounts_Receveivable.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'NP Aged Accounts Receivable';
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempCustLedgEntryLoop; "Integer")
                    {
                        ...
                        column(CLEEEndDateExtDocNo; CustLedgEntryEndingDate."External Document No.")
                        {
                        }
